            ...
            className={classNames('radial-chart', className, {
                ...
                <svg viewBox="0 0 180 180" width={dimension} height={dimension}>
                   <circle
                       ...
                       r={circleRadius}
                   />
                   <text x="50%" y="45%" text-anchor="middle" fill={color.color2} fillOpacity="100%"  font-size="1.3em" font-family="Arial" dy=".3em">{unitName}</text>
                   <text x="50%" y="60%" text-anchor="middle" fill={color.color1} font-size="1.4em" fontWeight="bold" font-family="Arial" dy=".3em">{quantity + unit}</text>
